...
> implementati nel protocollo `89d814d7...`, incluso contratto frozen preflight/full, entry
> event-level strettamente successiva, negative-controls gate e future-mutation test. Il nuovo label
> hash è `e0e72584...`; non riusare le matrici precedenti. La checklist e i risultati aggiornati
