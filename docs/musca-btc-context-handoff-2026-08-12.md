...
> implementati nel protocollo `29607014...`, incluso contratto frozen preflight/full, entry
> event-level strettamente successiva, negative-controls gate e future-mutation test. Il nuovo label
> hash è `7e368172...`; non riusare le matrici precedenti. La checklist e i risultati aggiornati
